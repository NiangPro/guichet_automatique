...
public class FormDepot extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(depot_numCpt== null){
            ...
            JOptionPane.showMessageDialog(null, "Vous n'avait pas de compte pour le moment", "Depot", JOptionPane.ERROR_MESSAGE);
        }else{
            if(mt.isEmpty()){
                    ...
                    try {
                        if(rs.next()){
                            if(rs.getString("type").equals("Marge Credit")){
                                JOptionPane.showMessageDialog(null, "Impossible de faire un dépôt avec la marge de crédit", "Depot", JOptionPane.ERROR_MESSAGE);
                            }else{
                            ...
                            JOptionPane.showMessageDialog(null, "Erreur de dépôt", "Depot", JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (SQLException ex) {
                        Logger.getLogger(FormDepot.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }else{
                    JOptionPane.showMessageDialog(null, "Veuillez entrer un montant positif", "Depot", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
